...
def PolarizabilityMatrices(omega, a, epsilon, multipliers=(1,0,0)):
    ...
    for i in range(len(omega)):
        output.append(PolarizabilityMatrix(omega[i], a, epsilon[i], multipliers=(1,0,0)))
    return output
...
Omegas = np.linspace(3,9,50) * const.eV/const.hbar
...
print(f"Spectrum will be saved to {filename}")
